 ...
 * @returns {any}
 */
export function generate_bindgen_nodejs(name, wasm_bytes) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(
      name,
...
const imports = {
  __wbindgen_placeholder__: {
    ...
    __wbg_set_c943d600fa71e4dd: function (arg0, arg1, arg2) {
    ...
    __wbg_String_c9c0f9be374874ba: function (arg0, arg1) {
 ...
 *   exports: { generate_bindgen: typeof generate_bindgen; generate_bindgen_nodejs: typeof generate_bindgen_nodejs }
 * }>}
 */
...
function getWasmInstanceExports() {
  return { generate_bindgen, generate_bindgen_nodejs };
}
...
async function instantiateModule(opts) {
  ...
  const wasmUrl = import.meta.url.includes("_frsh")
    ? opts.url
    : new URL("wasmbuild_bg.wasm", import.meta.url);
